...
typedef enum { ESHANDSHAKE, ESDATOS, ESSTRING, ESARCHIVO, ESINT, ESERROR, NUEVOWORKER, TRANSFWORKER, VALIDACIONWORKER,
	...
	SOLICITUDTRANSFORMACION, SOLICITUDREDUCCIONLOCAL, SOLICITUDREDUCCIONGLOBAL, SOLICITUDALMACENADOFINAL,SOLICITUDARCHTEMP, ARCHIVOTEMPRL,FINARCHIVOTEMPRL,LISTAWORKERS,
	FINTRANSFORMACION, FINREDUCCIONLOCAL, FINREDUCCIONGLOBAL, FINALMACENADOFINAL, SOLICITUDBLOQUECPTO,RESPUESTASOLICITUDCPTO,
	RESPUESTAGETBLOQUE,SETBLOQUECPTO,RESPUESTASETBLOQUECPTO,CONTINUA} tipo;
