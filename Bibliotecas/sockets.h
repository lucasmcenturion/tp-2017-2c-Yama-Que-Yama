...
typedef enum { ESHANDSHAKE, ESDATOS, ESSTRING, ESARCHIVO, ESINT, ESERROR, NUEVOWORKER, TRANSFWORKER, VALIDACIONWORKER,
	...
	SOLICITUDTRANSFORMACION, ARCHIVOTEMPRL,LISTAWORKERS, FINTRANSFORMACION, FINREDUCCIONLOCAL, FINREDUCCIONGLOBAL,
	SOLICITUDBLOQUECPTO,RESPUESTASOLICITUDCPTO,RESPUESTAGETBLOQUE,SETBLOQUECPTO,RESPUESTASETBLOQUECPTO} tipo;
